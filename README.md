...
1. [Projet](#projet)
    ...
    1.4 [Utilisation de MongoDB dans notre projet](#utilisation-de-mongodb-dans-notre-projet)
        1.4.1 [Mise en place de MongoDB](#mise-en-place-de-mongodb)
        1.4.2 [Fonctionnalités avancées](#fonctionnalités-avancées)
            1.4.2.1 [MongoDB plutot que SQL](#mongodb-plutot-que-sql)
            1.4.2.2 [BigData](#bigdata)
            1.4.2.3 [Stockage de fichiers dans notre projet](#stockage-de-fichiers-dans-notre-projet)
            1.4.2.4 [Utilisation des requêtes Géospaciales](#utilisation-des-requêtes-géospaciales-httpsdocsmongodbcommanualgeospatial-queries)
            1.4.2.5 [Utilisation de l'aggrégation](#utilisation-de-laggrégation)
